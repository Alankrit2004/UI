...
export function EmpHistory() {
  ...
  // Filter the data for inactive users
  const inactiveUsers = data?.filter(user => user.isActive === false);
  const inactiveCount = inactiveUsers.length; // Total count of inactive users
  ...
  return (
    <>
      ...
      {Permission?.view && (
        <AppTable
          columns={columns}
          data={inactiveUsers}  // Filtered data for inactive users
          loading={loading}
          pageNo={filter.pageNo}
          pageSize={filter.pageSize}
          totalCount={inactiveCount}  // Use the inactive count here
